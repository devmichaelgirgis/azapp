...
public class TicketModelStringArrayConverter {
    @TypeConverter
    public static ArrayList<Ticket> fromString(String value) {
    ...
    @TypeConverter
    public static String fromArrayList(ArrayList<Ticket> list) {
        Gson gson = new Gson();
